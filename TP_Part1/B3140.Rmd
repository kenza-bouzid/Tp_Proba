...
On a ici un * $\alpha$ supérieur à 0. C'est à dire qu'on plus de personnes arrivant dans la file que de personne partant de la file. Le nombre de personnes croît continuellement, on a donc ici une courbe prédictible qui va systématiquement diverger.   
